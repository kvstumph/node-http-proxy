...
common.setupOutgoing = function(outgoing, options, req, forward) {
  ...
  //KVS BEGIN work-around
  var isSocketIo = /\/socket\.io($|\/)/i;
  var isWebsocket = /\/websocket($|\/)/i;
  if(isSocketIo.test(req.url) || isWebsocket.test(req.url)) {
    //console.log('KVS SOCKETIO CASE MATCH: ' + req.url);
    outgoing.headers = extend({}, req.headers);
  }
  else {
    //console.log('KVS NO MATCH: ' + req.url);
    var rawHeaders = {};
